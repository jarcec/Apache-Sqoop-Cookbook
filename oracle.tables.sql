...
CREATE TABLE "staging_cities" AS SELECT * FROM "cities" WHERE 1 = 0;

-- Create synonym CIT to table cities
CREATE SYNONYM "cit" FOR "cities";
...
INSERT INTO "visits"("id", "city", "last_update_date") VALUES(1, 'Freemont', TIMESTAMP '1983-05-22 01:01:01');
INSERT INTO "visits"("id", "city", "last_update_date") VALUES(2, 'Jicin', TIMESTAMP '1987-02-02 02:02:02');
